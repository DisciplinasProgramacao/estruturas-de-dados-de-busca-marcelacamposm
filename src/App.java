    ...
    */
    	...
    	try {
    		...
    		for (int i = 0; i < numProdutos; i++) {
    			...
    			try {
    			    ...
    			    System.out.println("Produto inválido ignorado: " + linha);
    			}
    		}
    	    ...
    	    System.out.println("Formato inválido no arquivo de produtos");
    	    produtosCadastrados = null;
    	} finally {
    		if (arquivo != null) {
    		    arquivo.close();
    ...
    static Produto localizarProdutoID(ABB<Integer, Produto> produtosCadastrados) {
        ...
        if (produtosCadastrados == null) {
            System.out.println("Árvore de produtos não foi carregada!");
            return null;
        }
	...
	public static void main(String[] args) {
        ...
        try {
            ...
            if (produtosBalanceadosPorId == null || quantosProdutos == 0) {
                System.out.println("Erro ao carregar produtos. Encerrando aplicação.");
                teclado.close();
                return;
            }
            ...
            System.out.println("Erro inesperado: " + excecao.getMessage());
        } finally {
            teclado.close();
        }
    }
